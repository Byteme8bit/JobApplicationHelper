...
def run_gui():
    ...
    config_path_entry.grid(row=0, column=1, columnspan=3, padx=5, pady=2)
    config_browse_button = ttk.Button(root, text="Browse", command=browse_config_file)
    config_browse_button.grid(row=0, column=4, padx=5, pady=2)
    ...
    template_path_entry.grid(row=1, column=1, columnspan=3, padx=5, pady=2)
    template_browse_button = ttk.Button(root, text="Browse", command=browse_template_file)
    template_browse_button.grid(row=1, column=4, padx=5, pady=2)
    ...
    output_filename_entry.grid(row=2, column=1, columnspan=3, padx=5, pady=2)
    ...
    placeholders_text = tk.Text(root, height=10, width=50) #Increased width
    placeholders_text.grid(row=3, column=1, columnspan=4, padx=5, pady=2, sticky="nsew") #Increased columnspan, added sticky
    ...
    placeholder_entry.grid(row=4, column=1, padx=5, pady=2)
    ...
    replace_with_entry.grid(row=5, column=1, padx=5, pady=2)

    add_placeholder_button = ttk.Button(root, text="Add Placeholder", command=add_placeholder)
    add_placeholder_button.grid(row=4, column=2, rowspan=2, padx=5, pady=2)
    ...
    root.columnconfigure(1, weight=1) #Make the entry columns expandable
    root.mainloop()
